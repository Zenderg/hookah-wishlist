  ...
  return (
    <Link
      ...
      className={`flex flex-col items-center justify-center px-4 py-2 rounded-lg transition-all duration-200 ${
        isActive
          ? 'text-tg-button bg-tg-secondary-bg'
          : 'text-tg-hint hover:text-tg-text hover:bg-tg-secondary-bg'
      }`}
    >
      {icon}
...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-tg-bg border-t border-tg-hint z-50 shadow-lg">
